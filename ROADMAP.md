...
**Current:** v0.56.0 shipped. Wave 4 High/Medium all done. Remaining: M10 M2 (Rust worker), M11 M2 (plugin-install), M20 M2 (agent-slot shared state).  
